...
export function PendingDetails() {
  ...
  console.log('jsdfhdijsfds0', item);
  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.buttonView}>
        ...
        {item?.ride_status?.slug === 'cancelled' && <View style={{ marginTop: windowHeight(-9), backgroundColor: appColors.red + 20, width: '90%', borderRadius: windowWidth(4), alignSelf: 'center' }}>
          <Text style={{ color: appColors.red, fontSize: windowWidth(4), marginHorizontal: windowWidth(4), marginVertical: windowHeight(1), marginBottom: 0 }}>Cancellation Reason: </Text>

          {item?.ride_status?.slug === 'cancelled' && <Text style={{ color: appColors.red, fontSize: windowWidth(4), marginHorizontal: windowWidth(4), marginVertical: windowHeight(1) }}>{item?.cancellation_reason}</Text>}
        </View>}
      </View>
